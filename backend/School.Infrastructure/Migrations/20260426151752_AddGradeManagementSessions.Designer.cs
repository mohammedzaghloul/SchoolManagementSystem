...
namespace School.Infrastructure.Migrations
{
    ...
    [Migration("20260426151752_AddGradeManagementSessions")]
    partial class AddGradeManagementSessions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School.Domain.Entities.GradeSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassId", "SubjectId", "Type", "Date")
                        .IsUnique();

                    b.ToTable("GradeSessions");
                });

            modelBuilder.Entity("School.Domain.Entities.GradeUpload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GradeUploads");
                });

            modelBuilder.Entity("School.Domain.Entities.GradeUploadConfirmation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TeacherId", "SubjectId", "GradeType", "Date")
                        .IsUnique();

                    b.ToTable("GradeUploadConfirmations");
                });
            ...
            modelBuilder.Entity("School.Domain.Entities.TuitionInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School.Domain.Entities.Grade", b =>
                {
                    b.HasOne("School.Domain.Entities.GradeSession", "Session")
                        .WithMany("Grades")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
